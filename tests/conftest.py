...
@pytest.fixture()
def basic_player_stats_skip_rank_response():
    with open(get_full_filepath('basic_player_stats_skip_rank_response.json')) as json_file:
        yield json.load(json_file)


@pytest.fixture()
def basic_player_stats_no_badges_response():
    with open(get_full_filepath('basic_player_stats_no_badges_response.json')) as json_file:
        yield json.load(json_file)
